...
export default function Bikes({ bike, session }) {
  ...
  return (
    <>
      <div className="group">
        <div className="border h-[328px] mb-1 p-4 overflow-hidden relative">
          <div className="flex justify-center items-center bg-primary/5 w-full h-full group-hover:bg-primary/10 transition-all duration-300">
            ...
            <Image src={urlFor(bike.images[0]).url()} alt={bike.name} title={bike.name} width={230} height={230} className="object-cover md:hover:scale-105" />
          </div>
