...
export default async function ProductDetail({ params }) {
  ...
  return (
    <>
      <section className="bg-amber-500 pt-24 pb-32">
        <div className="container mx-auto">
          <div className="flex flex-col xl:flex-row gap-14">
            <div className="bg-primary/5 xl:flex-1 flex justify-center items-center h-[460px] xl:h-[540px] xl:w-[700px]">
              <Suspense fallback={<p>Loading...</p>}>
                <Image src={urlFor(bike.images[0]).url()} alt={bike.name} width={480} height={480} priority />
              </Suspense>
            </div>
